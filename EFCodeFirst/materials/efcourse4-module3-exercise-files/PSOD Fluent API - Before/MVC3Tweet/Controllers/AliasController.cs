...
{ 
    public class AliasController : Controller
    {
        ...
        public ViewResult Details(int id)
        {
           ...
           // var alias=db.Aliases.Include("Avatar").FirstOrDefault(a => a.AuthorKey == id);
            return View(alias);
        }

        public FileContentResult ShowImage(string image)
        {
            return File(System.Convert.FromBase64String(image), System.Net.Mime.MediaTypeNames.Image.Jpeg);
